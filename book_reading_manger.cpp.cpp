...
public:
	...
	void LoadDatabase() {
		...
		book1->SetIsbn("00023");
		book1->SetAuthor("JK");
		book1->SetTitle("Master Python");
		vector<string> pages1 = { "Andex", "p1", "p2" };
		...
		book2->SetIsbn("5342");
		book2->SetAuthor("PK");
		book2->SetTitle("DataBase");
		vector<string> pages2 = { "Laaa", "KAAAA" };
